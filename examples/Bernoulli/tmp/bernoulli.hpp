...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/CmdStan/examples/Bernoulli/tmp/bernoulli.stan");
    reader.add_event(11, 11, "end", "/Users/rob/.julia/dev/CmdStan/examples/Bernoulli/tmp/bernoulli.stan");
    return reader;
}
