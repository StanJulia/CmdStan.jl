...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/CmdStan/examples/tmp/bernoulli.stan");
    reader.add_event(12, 12, "end", "/Users/rob/.julia/dev/CmdStan/examples/tmp/bernoulli.stan");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("empty", "0", 0);
            context__.validate_dims("data initialization", "empty", "double", context__.to_vec(0));
            validate_non_negative_index("empty", "0", 0);
            empty = std::vector<double>(0,double(0));
            vals_r__ = context__.vals_r("empty");
            pos__ = 0;
            size_t empty_limit_0__ = 0;
            for (size_t i_0__ = 0; i_0__ < empty_limit_0__; ++i_0__) {
                empty[i_0__] = vals_r__[pos__++];
            }
